...
var broadcast = function(config) {
    ...
    function onDefaultSocketResponse(response) {
        ...
        if (response.userToken && response.joinUser == self.userToken && response.participant && channels.indexOf(response.userToken) == -1) {
            ...
            openSubSocket({
                uniqueAddressToken : response.uniqueAddressToken,
                isofferer: true,
        ...
        var peerConfig = {
            ...
            onICE: function(candidate) {
                socket.send({
                    ...
                    uniqueAddressToken : _config.uniqueAddressToken,
                    candidate: {
    ...
    function startBroadcasting() {
      //roomToken: 'f30b8af1-dc6b-1e33-288e-49533ed27e68',
 //roomName: 'sfs',
 //broadcaster: 'b18e389c-2be1-7041-e00-22e2ccf65f4c
        defaultSocket && defaultSocket.send({
            roomToken: self.roomToken,
            roomName: self.roomName,
            broadcaster: self.userToken,
            uniqueAddressToken: self.uniqueAddressToken
        });
    ...
    return {
        createRoom: function(_config) {
            ...
            self.uniqueAddressToken = _config.uniqueAddressToken;
